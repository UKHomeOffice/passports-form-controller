...
describe('Validators', function () {
    ...
    describe('title', function () {
        ...
        describe('invalid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.title(i).should.not.be.ok;
                });
            });
        });
        ...
        describe('valid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.title(i).should.be.ok;
                });
            });
        });
    ...
    describe('othertitle', function () {
        ...
        describe('invalid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.othertitle(i).should.not.be.ok;
                });
            });
        });
        ...
        describe('valid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.othertitle(i).should.be.ok;
                });
            });
        });
    ...
    describe('firstname', function () {
        ...
        describe('invalid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.firstname(i).should.not.be.ok;
                });
            });
        });
        ...
        describe('valid values', function () {
            var inputs = [
                'John Smith',
                'Paddy O\'Doyle',
                'Rory Fotherington-Smythe',
                'John, Smith'
            ];
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.firstname(i).should.be.ok;
                });
            });
        });
    ...
    describe('surname', function () {
        ...
        describe('invalid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.surname(i).should.not.be.ok;
                });
            });
        });
        ...
        describe('valid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.surname(i).should.be.ok;
                });
            });
        });
    ...
    describe('placename', function () {
        ...
        describe('invalid values', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.placename(i).should.not.be.ok;
                });
            });
        });
        ...
        describe('valid values', function () {
            var inputs = [
                ...
                'Ashby-de-la-Zouch',
                'Trinidad & Tobago',
                'S0mehow 4 town with numb3rs'
            ];
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.placename(i).should.be.ok;
                });
            });
        });
    ...
    describe('certnum', function () {
        ...
        describe('invalid inputs', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.certnum(i).should.not.be.ok;
                });
            });
        });
        ...
        describe('valid inputs', function () {
            ...
            _.each(inputs, function (i) {
                it(testName(i), function () {
                    Validators.certnum(i).should.be.ok;
                });
            });
        });
